package com.neustar.droolsdemo.config;
...
public class DroolsConfig {
    ...
    public KieContainer kieContainer() {
        ...
        KieContainer kContainer = ks.newKieContainer(droolsDemoKJar(ks));
        ...
        KieModuleMetaData kieModuleMetaData = KieModuleMetaData.Factory.newKieModuleMetaData(droolsDemoKJar(ks));
    ...
    private ReleaseId droolsDemoKJar(KieServices ks) {
        return ks.newReleaseId("com.neustar", "droolsdemo", "1.0");
    }
